...
The value of each random variable is,
\begin{align}
        X = 
        \begin{cases}
            0 & Black\\
       ...
       \\ Y = 
        ...
        \end{cases}
\end{align}
Also the pmfs of each random variable are:
\begin{align}
\pr{X=i} = \frac{1}{2} \; \forall \;  i \in [0,1]
\\ \pr{Y=i} = \frac{1}{4} \; \forall \; i \in [1,4]
\\ \pr{Z=i} = \frac{1}{13} \; \forall \; i \in [1,13]
\end{align}
...
\begin{align}
\pr{X=1,Z=13} &= \pr{X=1} \times \pr{Z=13}\nonumber
\\&= \frac{1}{2} \times \frac{1}{13} = \frac{1}{26}
\end{align}
\item Probability of drawing a Face Card:
\begin{align}
\pr{Z=11,12,13} &= \sum_{i=11}^{13}\pr{Z=i}\nonumber
\\&= 3 \times \frac{1}{13} = \frac{3}{13}
\end{align}
\item Probability of drawing a Red Face Card:
\begin{align}
\pr{X=1, Z=11,12,13} &= \sum_{i=11}^{13}\pr{Z=i} \times \pr{X=1}\nonumber
\\&= \frac{1}{2} \left(3 \times \frac{1}{13} \right) = \frac{3}{26}
\end{align}
\item Probability of drawing the Jack of Hearts:
\begin{align}
\pr{Y=3, Z=11} &= \pr{Y=3} \times \pr{Z=11}\nonumber 
...
\begin{align}
\pr{Y=1, Z=12} &= \pr{Y=1} \times \pr{Z=12}\nonumber 
\\&= \frac{1}{4} \times \frac{1}{13} = \frac{1}{52}
\end{align}
\end{enumerate}
\end{document}